...
if __name__ == "__main__":
	...
	for file_index in [0, 1]:
		...
		#fa_rbf = RBFN.Radial_Basis_Function_Network(train=fa_train, test=fa_test, M=mse_best_m, s=mse_best_s, metric = "MSE")
		#fa_predicted_y, mse_performance = fa_rbf.run()
		#print()
		...
		#print("The best m, s for regression and performance are", mse_best_m, mse_best_s, mse_performance)
		...
		print("The best m, s for classification and performance are ", acc_best_m, acc_best_s, acc_performance)
